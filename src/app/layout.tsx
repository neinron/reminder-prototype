  ...
  return (
    <html lang="de" translate="yes">
      ...
      >
        ...
        <footer className="w-full h-[180px] bg-black flex flex-col justify-between px-6 py-4">
          <div className="flex flex-col items-center">
            {/* Logo links oben */}
            <div className="flex flex-col items-center z-10 mt-4  mb-4">
              <a href="/">
                <img src="/logo-wemolo-white@4x.png" alt="Wemolo Logo" style={{height: "auto", width: 170, marginBottom: 16, cursor: 'pointer'}} />
              </a>
              <p className="text-white text-xs mb-2"> &copy; 2025 Wemolo GmbH</p>
            </div>
            {/* Impressum und Datenschutz */}
            <div className="flex flex-col items-center justify-center gap-2">
              <div className="flex flex-col items-center justify-center gap-2">
                <a href="/datenschutz" className="text-white text-xs hover:text-[#5046e8] transition-colors">Datenschutzerklärung</a>
                <a href="/impressum" className="text-white mb-6 text-xs  hover:text-[#5046e8] transition-colors">Impressum</a>
              </div>
            </div>
          </div>
        </footer>
